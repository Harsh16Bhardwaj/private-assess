  ...
  return (
    <main className="screen workspace-screen">
      ...
      <section className="warning-modal" role="dialog" aria-modal="true" aria-labelledby="modal-title">
        <header>
          <h2 id="modal-title">Stay in this assessment</h2>
          <strong>Warning: First of 3</strong>
        </header>
        <p>Pasting and switching tabs aren’t allowed. This activity may be recorded.</p>
        <div className="modal-actions">
          <Button variant="ghost">Exit assessment</Button>
          <Button variant="danger">I understand</Button>
        </div>
      </section>
    </main>
  );
